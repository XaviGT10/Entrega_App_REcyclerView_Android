...
data class Base(
    ...
    @SerializedName("forks_url") val url_forks : String,
    ...
    @SerializedName("homepage") val home : String,
    @SerializedName("size") val size : Int,
    @SerializedName("stargazers_count") val numStargazers : Int,
    @SerializedName("watchers_count") val numWatchers : Int,
    @SerializedName("language") val language : String,
    @SerializedName("has_issues") val issues : Boolean,
